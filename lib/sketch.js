...
//flora generator
if(frameCount % 120 === 0) {
    var flora = createSprite(width,250,10,40);
    ...
    switch(rand) {
      ...
      case 4: flora.addImage(flora4);
              flora.position.y = 255;   
              break;
      case 5: flora.addImage(flora5);
              flora.position.y = 252.5;   
              break;
      case 6: flora.addImage(flora6);
              flora.position.y = 300;
              break;
      default: break;
    }
...
//willow generator
if(frameCount % 160 === 0) {
    var willow = createSprite(width,275,10,40);
    ...
    switch(rand) {
      ...
      case 4: willow.addImage(willow4);
              willow.position.y = 270;
              break;
      case 5: willow.addImage(willow5);
              willow.position.y = 245;
              break;
      case 6: willow.addImage(willow6);
              willow.position.y = 230;
              break;
      default: break;
    }
...
//light generator
if(frameCount % 240 === 0) {
    var light = createSprite(width,300,10,40);
...
//blade spawner
if(frameCount % 550 === 0) {
    var blade = createSprite(width,65,10,40);
...
//thorn spawner
if(frameCount % 550 === 0) {
    var thorns = createSprite(width,355,10,40);
...
//stalactite spawner
if(frameCount % 860 === 0) {
    var stalactite = createSprite(width,height,10,40);
    stalactite.addImage(stalactiteImg);
    stalactite.velocity.x = ground.velocity.x;
    stalactite.velocity.y = (1 + 1 * score/1000) * 5;
    stalactite.scale = 2;
    stalactite.life = 250;
...
//trap spawner
if(frameCount % 990 === 0) {
    var trap = createSprite(width,-height,10,40);
...
function coins(){
if(frameCount % 60 === 0) {
    var coin = createSprite(width,150,10,40);
