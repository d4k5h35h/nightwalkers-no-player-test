...
if(frameCount % 160 === 0) {
    ...
    switch(rand) {
      case 1: willow.addImage(willow1);
              willow.position.y = ground.position.y - 100;
              break;
...
if(frameCount % 240 === 0) {
    ...
    light.addAnimation("light1", light1);
    light.addImage("light2", light2);
    
    //generate random light
    var rand = Math.round(random(1,2));
    switch(rand) {
      case 1: light.changeAnimation("light1");
              break;
      case 2: light.changeImage("light2");
              break;
      default: break;
    }
...
//thorn spawner
if(frameCount % 550 === 0) {
    var thorns = createSprite(width + 35,ground.position.y - 70,10,40);
