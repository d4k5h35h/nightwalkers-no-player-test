...
//light pngs
    light1 = loadAnimation("dungLight(1).png", "dungLight(2).png", "dungLight(3).png");
...
//flora generator
if(frameCount % 120 === 0) {
    var flora = createSprite(width + 10,ground.position.y - 275,10,40);
...
//willow generator
if(frameCount % 160 === 0) {
    var willow = createSprite(width + 10,ground.position.y - 150,10,40);
...
//light generator
if(frameCount % 240 === 0) {
    var light = createSprite(width + 10,ground.position.y - 75,10,40);
    light.velocity.x = ground.velocity.x;
    
    //generate random light
    var rand = Math.round(random(1,2));
    switch(rand) {
      case 1: light.addAnimation(light1);
              break;
...
//blade spawner
if(frameCount % 450 === 0) {
    var blade = createSprite(width + 10,50,10,40);
...
//thorn spawner
if(frameCount % 550 === 0) {
    var thorns = createSprite(width + 10,ground.position.y - 75,10,40);
...
//stalactite spawner
if(frameCount % 295 === 0) {
    var stalactite = createSprite(width + 10 + 10,30,10,40);
...
//trap spawner
if(frameCount % 370 === 0) {
    var trap = createSprite(width + 10,ground.position.y - 20,10,40);
...
function coins(){
if(frameCount % 60 === 0) {
    var coin = createSprite(width + 10,height / 3,10,40);
